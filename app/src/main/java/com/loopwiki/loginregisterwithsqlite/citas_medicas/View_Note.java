...
public class View_Note extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent setIntent = new Intent(this, Medic.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_back:
                Intent openMainActivity = new Intent(this, Medic.class);
                ...
                builder
                        ...
                        .setPositiveButton(getString(R.string.yes), new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                db.close();
                                Intent openMainActivity = new Intent(View_Note.this, Medic.class);
                                startActivity(openMainActivity);
